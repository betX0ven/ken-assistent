...
all_answers = ['погода', 'время', 'стим', 'браузер', 'музыка', 'сетевой', "школьное расписание", 'расписание', '']
...
training_data = [
    # Команды
    ("запусти браузер", "command"),
    ("включи все системы", "command"),
    ("открой программу", "command"),
    ("скинь расписание", "command"),
    ("проанализируй меня", "command"),
    ("покажи меня", "command"),
    ("активируй протокол", "command"),
    ("включи музыку", "command"),
